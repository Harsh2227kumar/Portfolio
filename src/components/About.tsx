...
const About = () => {
  ...
  return (
    <section ref={containerRef} id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/80 backdrop-blur-sm relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="gsap-text text-2xl font-bold text-white mb-4">Professional Summary</h3>
          ...
          <div className="grid gap-6">
            <div className="gsap-card bg-gray-700/50 p-6 rounded-lg border border-purple-500/20 hover:border-purple-500/50 transition-all duration-300">
            ...
            <div className="gsap-card bg-gray-700/50 p-6 rounded-lg border border-blue-500/20 hover:border-blue-500/50 transition-all duration-300">
              <div className="flex items-center mb-4">
            ...
            <div className="gsap-card bg-gray-700/50 p-6 rounded-lg border border-green-500/20 hover:border-green-500/50 transition-all duration-300">
              <div className="flex items-center mb-4">
